...
public class    SoccerManagerUI {
    public static void main(String[] args) {
        ...
        Goalkeeper goalkeeper = new Goalkeeper("Bürki", 30, 7, 2, 10, 7, 7);
        Team dortmund = new Team("Borussia Dortmund", coach, goalkeeper); dortmund.addPlayer(new Player("Meunier", 29, 7, 5, 8, 0));
        ...
        goalkeeper = new Goalkeeper("Pavlenka", 28, 6, 2, 10, 6, 7);
        ...
        System.out.println(gameplay.calculateForceOfTheTeam(werder));
    }
}
